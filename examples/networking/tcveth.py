...
try:
   ...
   for v in l:
    ...
    ipr.tc("add-filter", "bpf", v, ":1", fd=fn.fd, name=fn.name, parent="ffff:fff2", classid=1)

    fn = b.load_func("redirect_pod_to_service", BPF.SCHED_CLS)
    ipr.tc("add-filter", "bpf", v, ":1", fd=fn.fd, name=fn.name, parent="ffff:fff3", classid=1)
